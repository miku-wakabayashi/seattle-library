...
<head>
    ...
    <title>宿・ホテル予約-旅行ならじゃらんnet</title>
    <link href="<c:url value="/resources/css/reset.css" />" rel="stylesheet" type="text/css">
    <link href="<c:url value="/resources/css/jaran.css" />" rel="stylesheet" type="text/css">
    <link href="https://fonts.googleapis.com/css?family=Noto+Sans+JP" rel="stylesheet">
</head>
<body>
    <!-- ヘッダー -->
    <div id="siteHeaderMountPoint">
        <header id="siteHeder" class="l-siteHeader">
            <div class="l-siteHeader_specialWeek">
                <div class="l-siteHeader_container">
                      <a href="https://www.jalan.net/theme/specialweek/?ccnt=specialweek210630_03">
                        <img src="https://www.jalan.net/jalan/doc/specialWeek/header/html/images/210630_top_specialweek_bnr.png">
                    </a>
                </div>
            </div>
            <div class="l-siteHeader_upper_wrapper">
                <div class="l-siteHeader_upper">
                    <div class="l-siteHeader_container l-siteHeader_upperContainer">
                        <p class="l-siteHeader_description">国内旅行・海外旅行や宿・ホテルの宿泊予約はじゃらんnet　～日本最大級の宿・ホテル予約サイト～</p>
                    </div>
                    
                    <ul class="l-siteHeader_helplinks">
                         <li class="l-siteHeader_helplink">
                            <a href="https://www.jalan.net/jalan/doc/howto/01goriyou.html">サイトのご利用方法</a>
                        </li>
                        <li class="l-siteHeader_helplink">
                            <a href="https://help.jalan.net/s/">ヘルプ/問合せ</a>
                        </li>                   
                    </ul>
                </div>
            </div> 
